...
export default function DurationChart({ confirmedStays }: Props) {
	...
	return (
		<div className="col-start-3 col-span-2  bg-grey-0 dark:bg-dark-grey-0 border border-grey-100 dark:border-dark-grey-100 rounded-md py-8 px-4 first:mb-6">
			<h2 className="text-lg">Stay duration summary</h2>
