	...
	return createPortal(
		<div className="fixed top-0 left-0 w-full h-[100dvh] bg-backdrop-color backdrop-blur-sm z-[1000] transition-all ">
			...
			>
				<button
					onClick={close}
					className="bg-none border-none p-[0.1rem] border rounded-sm translate-x-[0.8rem] transition-all absolute top-[1.2rem] right-[1.9rem] hover:bg-grey-200 active:bg-grey-300 [&>svg]:w-[2.4rem] [&>svg]:h-[2.4rem] [&>svg]:text-grey-500"
				>
					<HiXMark />
				</button>
